...
The notebook leverages a lot of the principles found in [this guide](https://docs.shadeform.ai/findingmostaffordablegpus) for using the platform to _find_ affordable GPU's.
