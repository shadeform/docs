...
We've created a [python notebook](https://github.com/shadeform/examples/find_and_use_gpus.ipynb) that uses the Shadeform API to do this for you. It's light in dependencies so it can run almost anywhere. Let's go through it:
