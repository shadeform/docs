---
title: 'Finding the Cheapest GPUs'
---
...
If we want an even cheaper instance but are willing to wait, we can also Schedule and instance instead. 
![Schedule](images/schedule.png)
Shadeform will handle acquiring the instances as soon as they come available.
...
We've created a [python notebook](Scriptlinkhere.com) that uses the Shadeform API to do this for you. It's light in dependencies so it can run almost anywhere. Let's go through it:
...
```python
print(response.text)
{"id":"11e8783c-3aec-4024-b3dd-5c4976ffe5d9","cloud_assigned_id":"1jm4ekhcgyvscg"}
```
![PendingAPI](images/pendingapi.png)
